...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            ...
            g.drawString("Score: " + ballsEaten, (SCREEN_WIDTH - metrics.stringWidth("Score: " + ballsEaten)) / 2,
                    g.getFont().getSize());
        } else {
            gameOver(g);
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + ballsEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: " + ballsEaten)) / 2,
                g.getFont().getSize());
        // Game Over text
        g.setColor(Color.red);
